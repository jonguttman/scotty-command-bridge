...
export async function GET() {
  try {
    ...
    const defaultOpenclawDir = process.platform === 'darwin'
      ? `${process.env.HOME || '/Users/openclaw'}/.openclaw`
      : '/root/.openclaw';
    const configPath = (process.env.OPENCLAW_DIR || defaultOpenclawDir) + "/openclaw.json";
